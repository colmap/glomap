...
// #include <glomap/sfm/basis/camera.h>
...
bool CheckCheirality(const Rigid3d &pose, const Eigen::Vector3d &x1, const Eigen::Vector3d &x2, double min_depth = 0., double max_depth = 100.);
