    ...
    image_t MaximumSpanningTree(const ViewGraph& view_graph,
        ...
        for (const auto& [pair_id, image_pair] : view_graph.image_pairs)
        {
            ...
            max_weight = std::max(max_weight,
                                  type == INLIER_RATIO ? image_pair.weight : static_cast<double>(image_pair.inliers.size()));
        }
        ...
        for (const auto& [pair_id, image_pair] : view_graph.image_pairs)
        {
            ...
            double weight = type == INLIER_RATIO ? image_pair.weight : static_cast<double>(image_pair.inliers.size());
