...
struct ImagePair {
    ...
    static inline image_pair_t ImagePairToPairId(const image_t image_id1, const image_t image_id2);

    static inline void PairIdToImagePair(const image_pair_t pair_id, image_t& image_id1, image_t& image_id2);
};

image_pair_t ImagePair::ImagePairToPairId(const image_t image_id1, const image_t image_id2) {
...
void ImagePair::PairIdToImagePair(const image_pair_t pair_id, image_t& image_id1, image_t& image_id2) {
