...
struct CameraRig : public colmap::CameraRig {
    ...
    CameraRig(const colmap::CameraRig& camera_rig) : colmap::CameraRig(camera_rig) {}

  double ComputeRigFromWorldScale(const std::unordered_map<image_t, Image>& images) const;
