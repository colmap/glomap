...
struct GlobalPositionerOptions : public OptimizationBaseOptions {
    ...
    double constraint_reweight_scale = 1.0; // only relevant for POINTS_AND_CAMERAS_BALANCED
...
protected:
    ...
    // Convert the results back to camera poses
    ...
    ceres::LossFunction* loss_function_ptcam_uncalibrated_ = nullptr;
    ceres::LossFunction* loss_function_ptcam_calibrated_ = nullptr;
