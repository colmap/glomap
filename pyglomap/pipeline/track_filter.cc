...
py::dict RunFilterTracksByReprojection(
  ...
  int counter = TrackFilter::FilterTracksByReprojection(view_graph, cameras, images, tracks, max_reprojection_error, in_normalized_image);
...
py::dict RunFilterTracksByAngle(
  ...
  int counter = TrackFilter::FilterTracksByAngle(view_graph, cameras, images, tracks, max_angle_error);
