...
std::shared_ptr<Image> MakeImage(image_t image_id,
                                 camera_t camera_id,
...
void BindImage(py::module& m) {
  ...
  PyImage.def(py::init<>())
      ...
      .def_property(
          ...
          "Normalized feature rays, can be obtained by calling "
          "UndistortImages.")
      .def_readonly("is_registered",
                    &Image::is_registered,
                    "Whether the image is registered.")
