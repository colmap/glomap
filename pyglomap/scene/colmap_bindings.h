...
struct type_caster<Eigen::Quaterniond> {
    ...
    // C++ to Python (cast)
    static handle cast(const Eigen::Quaterniond &src, return_value_policy, handle) {
        try {
            py::module pycolmap = py::module::import("pycolmap");
            py::object rotation_class = pycolmap.attr("Rotation3d");
...
template <> struct type_caster<colmap::Rigid3d> {
...
template <> struct type_caster<colmap::CameraModelId> {
    ...
    static handle cast(colmap::CameraModelId v, return_value_policy /*policy*/, handle /*parent*/) {
      try {
        py::module pycolmap = py::module::import("pycolmap");
        py::object camera_model_id_class = pycolmap.attr("CameraModelId");
...
template <> struct type_caster<glomap::Camera> {
    ...
    bool load(handle src, bool) {
        ...
        try {
            ...
            value.has_prior_focal_length = src.attr("has_prior_focal_length").cast<bool>();
        } catch (const py::cast_error &) {
            return false;
        }
        return true;
