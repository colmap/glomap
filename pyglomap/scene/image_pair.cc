...
std::shared_ptr<ImagePair> MakeImagePair(image_t image_id1, image_t image_id2, Rigid3d pose_rel) {
...
void BindImagePair(py::module& m) {
  ...
  PyImagePair.def(py::init<>())
      .def(py::init(&MakeImagePair),
          ...
          "image_id2"_a = -1,
          "pose_rel"_a = Rigid3d())
      .def_property_readonly("image_id1",
          [](const ImagePair& self) -> image_t {
            return self.image_id1;
          },
          "The unique identifier of the image 1.")
      .def_property_readonly("image_id2",
          [](const ImagePair& self) -> image_t {
            return self.image_id2;
          },
          "The unique identifier of the image 2.")
      .def_property_readonly("pair_id",
          [](const ImagePair& self) -> image_pair_t {
            return self.pair_id;
          },
      ...
      .def_readwrite("weight",
          &ImagePair::weight,
          "The initial inlier rate.")
      .def_property("cam2_from_cam1",
          [](const ImagePair& self) -> Rigid3d {
      ...
      .def("summary", [](const ImagePair& self) {
        ...
        ss << "ImagePair: " << self.image_id1 << " - " << self.image_id2 << std::endl;
